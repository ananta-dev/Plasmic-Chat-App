...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 3OB9jeYB3LR/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: d86Ip4QoqeG/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: Dl3Yf8Dq26e/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ulWlO)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__qei2)}
                role={"img"}
              />
            ),
